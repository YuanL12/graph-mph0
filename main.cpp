...
int test_5() {
    ...
    g.print_adjacency();
    g.print_filtration_value();
    auto [betti_0, betti_1, betti_2, betti_0_1, M] = compute_MPH0_DTree_Inplace<R2>(g, true);
...
mph0::print_timers();
    ...
    bool x_y_swap = true; // swap x and y coordinates if needed
...
int main(int argc, char** argv) {
    ...
    // std::cout << "--------------------------------" << std::endl;
    // std::cout << "Testing write graded graph to scc2020 format" << std::endl;
    // if (argc > 2) {
